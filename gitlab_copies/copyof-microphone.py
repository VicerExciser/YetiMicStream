### sensors/cnc_microphone/microphone/microphone.py
...
class MicrophoneSensor(SensorBase):
    ...
    def __init__(self, component_site, mic_number):
        super().__init__(component_site=component_site,
                         component_type=model.ComponentTypes.Sensor.value,
                         component_id=None,
        ...
        # threads
        '''
        self.posting_thread = Thread(target=self.post_cdn)
        self.posting_thread.start()
        self.my_logger.info('Starting Posting Thread')

        self.audio_thread = Thread(target=self.get_audio)
        self.audio_thread.start()
        self.my_logger.info('Starting Audio Thread')
        '''
        ...
        while True:
            if self.duration_update:
                ...
                try:
                    ...
                    start_time = SensorBase._get_timestamp()
                    frames = []
                    ...
                    end_time = SensorBase._get_timestamp()
